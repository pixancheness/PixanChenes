...
export const legendElTesoro: Legend = {
    id: "dona-alicia-tesoros",
    title: "Doña Alicia y sus tesoros",
    url: "/cuentos_leyendas/elTesoro",
    keywords: [
      "misterio",
      "destino",
      "tesoro",
    ...
    narrators: {
      ...
      storyteller: "Patricia Poot Matos",
      date: "2025-06-09"
    },
    metadata: {
      origin: `País: México. Región: Sur. Comunidad: San Francisco de Suc Tuc. 
  No hay fecha exacta del acontecimiento. 
  Sucesos importantes: 
  1. El encuentro con el mono. 
  2. El encuentro del tesoro. 
  3. Cuando su familia fue a verlo. 
  4. La escena del tesoro.`,
      summary: `Doña Alicia buscaba un tesoro, pero encontró su destino entre sombras y secretos del monte. 
  El monte guardó el tesoro... y también el alma de Doña Alicia. 
  No encontró oro, encontró su verdad en el misterio del monte que solo a ella le habló.`,
      characters: [
        {
          name: "Doña Alicia",
          description:
    ...
    content: {
      script: `
      En lo profundo del monte, donde el sol se filtra como un susurro entre las  ramas, doña Alicia buscaba leña. Viuda, ya entrada en años, caminaba sola  entre veredas antiguas, con su hipil blanco y la espalda vencida por el tiempo.  Comenzó a ir más tarde, cada vez más lejos, hasta que una sombra comenzó  a visitarla: un monito, menudo y oscuro, que la llamaba con la mano, "ven,  ven", le decía sin voz. Al principio lo ignoró, pero la curiosidad fue creciendo  como el musgo en las piedras, hasta que decidió seguirlo. La criatura danzaba  entre árboles y raíces, llevándola siempre más adentro, hasta un claro  encantado, donde florecían rosas junto a un río y un cofre repleto de oro  brillaba bajo la luna.

Doña Alicia no pudo cargar el tesoro, así que marcó el sitio con su pañuelo y  regresó al amanecer siguiente, esta vez con su familia, sus costales, su carreta  y su esperanza. Pero al llegar, el bosque no era el mismo. No había río, ni  flores, ni cofre. Solo tierra seca y monos inertes, cuerpos viejos sobre la piedra,  miradas vacías que parecían advertir lo que no debía tocarse. Un silencio  espeso los envolvió, y en los ojos de Alicia se sembró el desconcierto. Lo que  vio la noche anterior ya no existía, o quizás nunca existió. Pero algo —algo  profundo, invisible y antiguo— había cambiado dentro de ella. 

Cinco días después, la fiebre la abrazó con fuerza, como si la selva misma la  reclamara por haber roto un pacto. Murió con los labios cerrados, pero con los  ojos abiertos, fijos en algún punto que nadie más pudo ver. Su familia,  marcada por el misterio, aún habla de aquel monito, del oro, del lugar  prohibido. Dicen que fue elegida, y que lo que encontró era solo para ella.  Pero también dicen que el dios del monte le ofreció suerte, no para compartir, sino para cuidar… y que Alicia, sin saberlo, lo traicionó.
`,
      text: `Esta historia es contada por patricia matos Poot una señora que ha estado escuchando esta  versión desde pequeña y lo quiere compartir con los demás, al comienzo de esta historia doña  patricia, cuenta que no recuerda el segundo nombre de doña Alicia y de Carmen como  también su apellido y el lugar es algo que no debe de ser encontrado así que lo mantendrá en  secreto. 

Esta historia sucedo en el sur de México en la comunidad de san francisco suc tuc, no hay  fecha exacta de este acontecimiento, pero patricia nos compartió su descripción de doña  Alicia: 

Doña Alicia era una mujer de la tercera edad que tenía 57 años que vestía hipil, tenía sus ojos  negros y su cabello no era tan blanco tenia algunas mechas de color negro que era su tono  natural, ella tenía una inclinación en la espalda que la hacía parecer de estatura mediana,  como también la prima Carmen no era tan vieja ni tan joven tenía 50 años y vestía con su  hipil y era de estatura mediana. 
