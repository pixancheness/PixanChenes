      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="text-center mb-16">
          ...
          <div className="relative mx-auto mb-12">
            <SplitText
              text="Nuestra misión es impulsar el desarrollo integral y sustentable de las comunidades indígenas de la región de los Chenes."
              tag="h2"
          ...
          <div className="grid md:grid-cols-2 gap-12 items-center">
            <div>
              <img
                ...
                alt="Comunidad trabajando en desarrollo sustentable"
            ...
            <div className="flex flex-col justify-center">
              ...
              <p className="text-yellow-700 leading-relaxed text-lg mb-4">
                Cada día renovamos nuestro compromiso con la tierra, con nuestra
                comunidad y con las generaciones futuras.
              </p>
              <p className="text-yellow-700 leading-relaxed text-lg">
                Nuestra misión no es solo un ideal, es una práctica cotidiana
                que transforma vidas y territorios.
              </p>
            </div>
          </div>
        </div>
...
const misionItems = [
  ...
  },
  {
    ...
    description: "Garantizar la soberanía alimentaria de nuestras familias.",
    icon: (
      <svg
        className="w-8 h-8 text-white"
        fill="none"
